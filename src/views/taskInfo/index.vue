    ...
    <div class="task">
        <div class="queryCriteria">
            ...
            <div>
              <!-- <div class="task-tab">
                <ul>
                  <li v-for="(item, index) in taskTabList" :key="index" @click="switchSource(index)" :class="{ active: activeIndex === index }">{{ item.label }} : {{ item.value }}</li>
                </ul>
              </div> -->
              <div>
                <panel>

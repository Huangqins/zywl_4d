                    ...
                    <section>
                        <p>授权信息</p>
                         <div>
                               ...
                               <h5><i class="el-icon-search" style="margin-right:5px;"></i><el-button type="text" @click="dialogVisible=true">查看授权管理</el-button></h5>
                         </div>
                    </section>
                    <section>
                        <p>授权说明</p>
        ...
        <div>
             <panel title="升级管理">
                <div class="updateManage">
                    <p style="margin-left:20px">注意:<span>您距离上次版本升级已有xxx天。为了保证您在使用程序的稳定性和获得最新漏洞的扫描能力，请您及时升级！</span></p>
